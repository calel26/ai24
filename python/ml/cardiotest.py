...
mean_bikes = df["cnt"].mean()
above = df["cnt"] > mean_bikes
is_day_off = df["is_holiday"] or df["is_weekend"]

# Define features and target variables
# t2 = feels like
feature_names = ["wind_speed", "hum", "t2"]
X = df[feature_names, is_day_off]  # the X axis is equal to columns in featured_names
y = above
